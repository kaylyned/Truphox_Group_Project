<%@ Page Title="" Language="C#" MasterPageFile="~/MasterSupreme.Master" AutoEventWireup="true" CodeBehind="TAP.aspx.cs" Inherits="TruphoxGP.TAP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <br />
    <h1>Privacy Policy</h1>
    <asp:Button ID="btnFrench" runat="server" Text="Francais" OnClick="btnFrench_Click" />
    <asp:Button ID="btnEnglish" runat="server" Text="English" OnClick="btnEnglish_Click" />
    <asp:Panel runat="server" ID="englishPnl">
        <p>Effective date: October 11, 2018</p>
        <p>Truphox ( "we") operates the  https://github.com/mastersupreme/GroupProj website (the "Service").</p>
        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for Truphox is managed through <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy</a>.</p>
        <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from  https://github.com/mastersupreme/GroupProj</p>
        ...
        <h2>Use of Data</h2>
        <p>Truphox uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>Truphox will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
        <h2>Disclosure Of Data</h2>
        <h3>Legal Requirements</h3>
        <p>Truphox may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Truphox</li>
        ...
        <ul>
            <li>By email: truphox@gmail.com</li>
        </ul>
    </asp:Panel>
    <asp:Panel ID="frenchPnl" runat="server" Visible="false">
        <h1>Politique de Confidentialité</h1>
        <p>Date de prise d'effet: October 11, 2018</p>

        <p>Truphox ("nous", "notre", "nos") exploite le site web  https://github.com/mastersupreme/GroupProj (ci-après désigné par le terme "Service").</p>
        ...
        <p>Truphox utilise les données recueillies à des fins diverses:</p>
        <ul>
        ...
        <p>Truphox peut communiquer vos Données à Caractère Personnel si elle estime de bonne foi que cela est nécessaire pour:</p>
        <ul>
            <li>S'acquitter d'une obligation légale</li>
            <li>Protéger et défendre les droits ou les biens de Truphox</li>
